...
class Controller:
	...
	def __init__(self, verbose, ami, instance_type, key_name, security_groups):
		'''
...
def main(argv):
	...
	parser.add_argument('-i', '--ami', help='AWS AMI to use when making new workers', default='ami-448b2e2c')
